...
\noindent The final purpose of the project is to use more functionnalities as possible in an application to get a view of what is feasible. To save development time, the software (a task manager), realized in the first semester as part of the unit value \textit{Modélisation, Interface utilisateur, Conception Avancée (MICA)}, was chosen.
...
\noindent The task manager realized as part of the unit part MICA\protect\footnote{Modélisation, Interface utilisateur, Conception Avancée} is a sofware for managing daily tasks that everyone should make. It is a memory aid used by everyone.
