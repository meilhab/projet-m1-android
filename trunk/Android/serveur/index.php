...
if(connexionAutorisee()) {
	...
	"taches":[
			...
			{"idTache":2,"nomTache":"'.$_POST['identifiant'].'","descriptionTache":"'.$_POST['mdPasse'].'","dateLimite":"","idEtat":1,"idPriorite":4,"apourtag":[1,3],"apourfils":[]},
