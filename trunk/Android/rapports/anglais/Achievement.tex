...
%\begin{figure}[!ht]
%    \centering
%    \parpic[r]{\includegraphics[height=6cm]{home.png}}
%    \caption{Home Screen of the application}
%\end{figure}

\piccaption{Home Screen of the application}
\parpic[r]{\includegraphics[height=6cm]{home.png}}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=6cm]{orientation.png}
...
\piccaption{Add an user account}
\parpic[r]{\includegraphics[height=6cm]{add_user.png}}
...
\piccaption{Choice of synchronization mode}
\parpic[r]{\includegraphics[height=6cm]{synchronise.png}}
