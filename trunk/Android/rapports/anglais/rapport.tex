...
\usepackage {lmodern}
%\usepackage {picins} %image avec texte a côté
...
%\usepackage{shorttoc} %Pour créer un sommaire
\usepackage{caption}
...
\hypersetup{
    ...
    pdftitle={Rapport de projet tuteuré},    % title
    pdfauthor={Montavon Guillaume, Meilhac Benoit},     % author
    pdfsubject={\'Etude et développement avec la plate-forme Android},   % subject of the document
...
%redéfinition maketitle pour mettre en haut de page
\makeatletter
\renewcommand{\maketitle}{%
    ...
    \end{center}\par
    \vskip 1.5em%
	\thispagestyle{empty}% virer numérotation
	\setcounter{page}{0}% remettre compteur au début
	\clearpage
	\newpage
}
\makeatother
...
\author{Guillaume MONTAVON\\Benoît MEILHAC  %rajouter un \\ au besoin
	\vspace{5mm}
}

\date{
	\begin{center} 
		%\includegraphics[width=7cm,height=6cm]{ufr.jpeg}
		\includegraphics{ufc.png}
	\end{center}
	\vspace{10mm}
	\Huge{\textbf{Study and development with the Android platform}}\\
	\vspace{16mm}
	\normalsize{	
	Supervisors :\\
        Mr PIAT\\
...
\listoffigures
\addcontentsline{toc}{chapter}{List des Figures}
\clearpage
