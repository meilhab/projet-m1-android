...
public class Lanceur {
	...
	public static void main(String[] args) {
    	...
    	modele.getPionsJoueur1().add(new Position(4, 1));
    	modele.getPionsJoueur1().add(new Position(1, 1));
    	modele.getPionsJoueur1().add(new Position(2, 1));
    	modele.getPionsJoueur1().add(new Position(2, 2));
    	modele.getPionsJoueur1().add(new Position(4, 2));
    	modele.getPionsJoueur1().add(new Position(4, 0));
    	modele.getPionsJoueur1().add(new Position(2, 0));
    	modele.getPionsJoueur1().add(new Position(1, 2));
    	modele.getPionsJoueur1().add(new Position(3, 3));
    	modele.getPionsJoueur1().add(new Position(3, 4));
    	modele.getPionsJoueur1().add(new Position(1, 0));
    	...
    	modele.setNbPionsRestantsMain2(0);
    	System.out.println("aGagne : " + modele.aGagne(1));
